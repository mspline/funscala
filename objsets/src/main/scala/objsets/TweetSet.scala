...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = allTweets.filter(e => google.exists(s => e.text.contains(s)))
  lazy val appleTweets: TweetSet = allTweets.filter(e => apple.exists(s => e.text.contains(s)))
